...
(function() {
    ...
    function connectPC() {
        ...
        socket.on('push_progress', function(info) {
            ...
            loadingElem.innerHTML = 'loading : ' + info.progressRate + ' (' + info.load+ '/' + info.total + ')';
        ...
        socket.on('remove', function(path) {
            tizen.filesystem.resolve(path, function(data) {
                if(data.isDirectory) {
                    data.parent.deleteDirectory(data.fullPath, true, function() {
                        console.log('Directory Deleted');
                        reloadContent();
                    }, function(e) {
                    ...
                    data.parent.deleteFile(data.fullPath, function() {
