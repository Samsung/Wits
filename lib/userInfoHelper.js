...
module.exports = {
  ...
  getRefinedData: () => {
    ...
    result.deviceConnectPort = cInfo.deviceConnectPort;
  ...
  getDeviceInfo: async (deviceIp, port) => {
    ...
    return await deviceConnectHelper.getConnectedDeviceInfo(deviceIp, port);
  },
