...
module.exports = {
    ...
    moveFile: (src, dest) => {
        try {
            ...
            console.error(chalk.red(`Failed to moveFile: ${e}`));
            throw e;
        }
    },
    ...
    copyFile: (src, dest) => {
        try {
            ...
            console.error(chalk.red(`Failed to copyFile: ${e}`));
            throw e;
        }
    },
    ...
    chmodAll(path) {
        // switch (module.exports.PLATFORM) {
        //     case 'linux':
        //         fs.chmodSync(path, fs.constants.S_IXUSR);
        //         break;
        //     default:
