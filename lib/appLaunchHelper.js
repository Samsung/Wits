...
module.exports = {
    installPackage: (deviceInfo, hostAppName) => {
        ...
        console.log(util.ISSILENT);
        execSync(WGT_FILE_PUSH_COMMAND, { silent: util.ISSILENT });
        const result = execSync(APP_INSTALL_COMMAND, {
            silent: util.ISSILENT
        }).toString();
    ...
    terminateApp: (deviceName, hostAppId) => {
        ...
        execSync(APP_TERMINATE_COMMAND, { silent: util.ISSILENT });
    }
};
