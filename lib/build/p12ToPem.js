...
function p12ToPem(p12Buffer, password, type, keyfile, certfile) {
    console.log(
        moduleName,
        '================Converting ' + type + ' P12 file to Pem file'
    );
    ...
    if (entry.privateKey) {
        ...
        console.log(
            moduleName,
            'Converted pem private key file is in ' + keyfile
        );
    } else {
        console.log('');
    }
        ...
        parseString(data, { explicitArray: false }, function (err, result) {
            ...
            if (typeof activeProfile != 'undefined') {
                ...
                if (
                    ...
                    console.log(
                        moduleName,
                        'Find active profile:' + activeProfile
                    );
                    ...
                    if (
                        ...
                        console.log(
                            moduleName,
                            'Developer p12 File: ' + authorFile
                        );
                        console.log(
                            moduleName,
                            'Distributor p12 File: ' + distributorFile
                        );
                        profileFlag = true;
                    }
                }
...
function checkActiveProfile(profilePath) {
    ...
    if (flag) {
        ...
        console.debug(
            moduleName,
            'decodedDistributorPass:' + decodedDistributorPass
        );
