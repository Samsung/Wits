...
const certificatesPath = path.join(witsPath, '/.resource/certificate-generator/certificates/');
...
function checkActiveProfile(profilePath) {
    ...
    if(flag){
        ...
        if(fs.existsSync(distributorFile2)){
            ...
            var decodeDistributor2Pass = cryptUtil.decryptPassword(distributorPassword2);
