...
var profileFile = 'C:/tizen-studio-data/profile/profiles.xml';
...
var ACTIVE_PEM_FILE = {
    AUTHOR_KEY_FILE:
        certificatesPath +
        path.sep +
        'developer_active_cert/tizen_developer_private_key.pem',
    AUTHOR_CERT_FILE:
        certificatesPath +
        path.sep +
        'developer_active_cert/tizen_developer_cert.pem',
    DISTRIBUTOR_KEY_FILE:
        certificatesPath +
        path.sep +
        'distributor_active_cert/tizen_distributor_private_key.pem',
    DISTRIBUTOR_CERT_FILE:
        certificatesPath +
        path.sep +
        'distributor_active_cert/tizen_distributor_cert.pem',
    DISTRIBUTOR2_KEY_FILE:
        certificatesPath +
        path.sep +
        'distributor_active_cert/tizen_distributor2_private_key.pem',
    DISTRIBUTOR2_CERT_FILE:
        certificatesPath +
        path.sep +
        'distributor_active_cert/tizen_distributor2_cert.pem',
};
...
function p12ToPem(p12Buffer, password, type, keyfile, certfile) {
    console.log('================Converting ' + type + ' P12 file to Pem file');
        ...
        parseString(data, { explicitArray: false }, function (err, result) {
            ...
            if (typeof activeProfile != 'undefined') {
                ...
                if (
                    ...
                    var tmpDistributorFile =
                        extensionPath + profileItems[1].$.key;
                    if (
                    ...
                    var tmpDistributorFile2 =
                        extensionPath + profileItems[2].$.key;
...
function checkActiveProfile() {
    ...
    if (flag) {
        ...
        console.log('@@@@@@@@@@@@@@@@@@', decodedAuthorPass);
        console.log('@@@@@@@@@@@@@@@@@@', decodedDistributorPass);
