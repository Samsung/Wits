...
var AUTOR_SIGNATURE = path.join(util.WITS_BASE_PATH, '../', 'container', 'author-signature.xml');
var PUBLIC_SIGNATURE = path.join(util.WITS_BASE_PATH, '../', 'container', 'signature1.xml');
var PUBLIC_SIGNATURE2 = path.join(util.WITS_BASE_PATH, '../', 'container', 'signature2.xml');
